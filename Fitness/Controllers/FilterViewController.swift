...
class FilterViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        gyms = [Gym(classInstances: [], equipment: "", gymHours: GymHours(zero: nil, one: nil, two: nil, three: nil, four: nil, five: nil, six: nil), id: 1, name: "Helen Newman", location: -1, isGym: true, popularTimesList: PopularTimes(id: -1, gym: 1, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: []), imageURL: ""), Gym(classInstances: [], equipment: "", gymHours: GymHours(zero: nil, one: nil, two: nil, three: nil, four: nil, five: nil, six: nil), id: 2, name: "Teagle Up", location: -1, isGym: true, popularTimesList: PopularTimes(id: -1, gym: 2, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: []), imageURL: ""), Gym(classInstances: [], equipment: "", gymHours: GymHours(zero: nil, one: nil, two: nil, three: nil, four: nil, five: nil, six: nil), id: 3, name: "Teagle Down", location: -1, isGym: true, popularTimesList: PopularTimes(id: -1, gym: 3, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: []), imageURL: ""), Gym(classInstances: [], equipment: "", gymHours: GymHours(zero: nil, one: nil, two: nil, three: nil, four: nil, five: nil, six: nil), id: 4, name: "Noyes", location: -1, isGym: true, popularTimesList: PopularTimes(id: -1, gym: 4, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: []), imageURL: ""),Gym(classInstances: [], equipment: "", gymHours: GymHours(zero: nil, one: nil, two: nil, three: nil, four: nil, five: nil, six: nil), id: 5, name: "Appel", location: -1, isGym: true, popularTimesList: PopularTimes(id: -1, gym: 5, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: []), imageURL: ""), Gym(classInstances: [], equipment: "", gymHours: GymHours(zero: nil, one: nil, two: nil, three: nil, four: nil, five: nil, six: nil), id: 6, name: "Bartels", location: -1, isGym: true, popularTimesList: PopularTimes(id: -1, gym: 6, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: []), imageURL: "")]
