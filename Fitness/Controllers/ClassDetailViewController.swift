...
class ClassDetailViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        setupDateAndCalender()

        setupFunctionAndDescription()
    ...
    // MARK: - DATE & CALENDER VIEWS
    func setupDateAndCalender() {
        //DATE
    ...
    // MARK: - FUNCTION AND DESCRIPTION VIEWS
    func setupFunctionAndDescription() {
        //FUNCTION
