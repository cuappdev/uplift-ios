...
struct ProBio {
    ...
    public static func getAllPros() -> [ProBio] {
        return [getClaire(), getJuan(), getMadeline(), getStarks(), getCleo()]
    }
    
    public static func getClaire() -> ProBio {
        var urls: [PersonalLinkObject] = []
        urls.append(PersonalLinkObject(url: "https://www.instagram.com/thenvironmentalistbodybuilder/", site: .instagram))
        ...
        let proClaire = ProBio(id: "test", name: "Claire Ng", profilePic: "claire", secondaryProfilePic: "claireSecondary", bio: "Hi everyone! My name is Claire and some people know me as \"The Environmentalist Bodybuilder\". I'm currently a senior studying Marine Biology in the College of Agriculture and Life Sciences.", links: urls, expertise: ["Meditation", "Healthy Eating", "Cutting"], routines: [routine1, routine2, routine3], summary: "Meditation & eating healthy")
    ...
    public static func getJuan() -> ProBio {
        var urls: [PersonalLinkObject] = []
        urls.append(PersonalLinkObject(url: "https://www.instagram.com/jv_gar1012/", site: .instagram))
        urls.append(PersonalLinkObject(url: "https://www.facebook.com/profile.php?id=100010308969934", site: .facebook))
    ...
    public static func getMadeline() -> ProBio {
        var urls: [PersonalLinkObject] = []
        urls.append(PersonalLinkObject(url: "https://www.instagram.com/trainwithmadeline/", site: .instagram))
    ...
    public static func getStarks() -> ProBio {
        var urls: [PersonalLinkObject] = []
        urls.append(PersonalLinkObject(url: "https://www.instagram.com/starkstwins/", site: .instagram))
    ...
    public static func getCleo() -> ProBio {
        var urls: [PersonalLinkObject] = []
        urls.append(PersonalLinkObject(url: "https://instagram.com/fitnessbycleo", site: .instagram))
    ...
    public static func getMark() -> ProBio {
        var urls: [PersonalLinkObject] = []
        urls.append(PersonalLinkObject(url: "https://www.facebook.com/mark.rittiboon", site: .facebook))
