...
struct ProBio {
    ...
    public static func getStarks() -> ProBio {
        ...
        let proStarks = ProBio(id: "test", name: "Austin and Justin Starks", profilePic: "starks", secondaryProfilePic: "starks-secondary", bio: "We're twin powerbuilders: people who lift to get stronger and look better. As students, we're computational biology majors who intend to attend graduate school in bioinformatics, computational biology, or computer science.", links: urls, expertise: ["Powerlifting", "BodyBuilding"], routines: [routine1, routine2, routine3], summary: "Strength and Resistance Training")
        return proStarks
    }
